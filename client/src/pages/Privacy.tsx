          ...
          <div className="prose prose-lg max-w-none">
            {language === 'es' ? (
              <>
                ...
                <h2>7. Contacto</h2>
                <p>Si tiene preguntas sobre esta Política de Privacidad, puede contactarnos en eperez@asetrabalnearios.com.</p>
              </>
            ) : (
              <>
                ...
                <h2>7. Contact</h2>
                <p>If you have questions about this Privacy Policy, you can contact us at eperez@asetrabalnearios.com.</p>
              </>
            )}
          </div>
        </div>
