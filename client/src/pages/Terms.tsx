          ...
          <div className="prose prose-lg max-w-none">
            {language === 'es' ? (
              <>
                ...
                <h2>8. Contacto</h2>
                <p>Si tiene preguntas sobre estos Términos y Condiciones, puede contactarnos en eperez@asetrabalnearios.com.</p>
              </>
            ) : (
              <>
                ...
                <h2>8. Contact</h2>
                <p>If you have questions about these Terms and Conditions, you can contact us at eperez@asetrabalnearios.com.</p>
              </>
            )}
          </div>
        </div>
