          ...
          <div className="prose prose-lg max-w-none">
            {language === 'es' ? (
              <>
                ...
                <h2>5. Contacto</h2>
                <p>Si tiene preguntas sobre nuestra política de cookies, puede contactarnos en eperez@asetrabalnearios.com.</p>
              </>
            ) : (
              <>
                ...
                <h2>5. Contact</h2>
                <p>If you have questions about our cookie policy, you can contact us at eperez@asetrabalnearios.com.</p>
              </>
            )}
          </div>
        </div>
